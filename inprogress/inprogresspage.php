...
<head>
    ...
    <link rel="stylesheet" href="style-inprogresspage.css">
</head>
<body>
<div>
    <form class="new-note" action="ip-create.php" method="post">
        <input type="hidden" name="id" value="<?php echo $currentNote['id'] ?>">
        <input type="text" name="title" placeholder="Note title" autocomplete="off"
               value="<?php echo $currentNote['title'] ?>">
        <textarea name="description" cols="34" rows="25"
...
?></small>
                <form action="ip-delete.php" method="post">
